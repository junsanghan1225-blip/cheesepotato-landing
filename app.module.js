...
import { createClient } from './vendor/supabase-js.js?v=8c5da555';
// 앱(package.json)과 같은 줄기를 쓴다. 갈리면 앱에서는 읽히는 파일이
// 여기서는 안 읽히는(또는 그 반대) 일이 생긴다.
import * as XLSX from './vendor/xlsx.js?v=8c5da555';
// 커리큘럼. 내용과 엔진을 갈라 두면 글을 고치다 화면을 깨지 않는다.
import { COURSES } from './courses.js?v=8c5da555';
import { GLOSSARY, GLOSS_LANGS } from './glossary.js?v=8c5da555';
import { glossFind } from './gloss-find.js?v=8c5da555';
import { GRAMMAR } from './grammar.js?v=8c5da555';
import { GRAMMAR_EN } from './grammar-en.js?v=8c5da555';
import { grammarScan } from './grammar-find.js?v=8c5da555';
import { SB_CATS, SB_MORE, SB_SEED } from './sentences.js?v=8c5da555';
// 읽기 연습 지문. 길이(short·long) × 급수 여섯 칸.
import { READING } from './reading.js?v=8c5da555';
// TOPIK 유형 연습문제. 기출이 아니라 자체 제작이다.
import { TOPIK_READING, TOPIK_BLUEPRINT, TOPIK_SLOTS } from './topik.js?v=8c5da555';
import { TOPIK2_READING, TOPIK2_BLUEPRINT, TOPIK2_SLOTS } from './topik2.js?v=8c5da555';
// 숫자 게임의 읽기와 문제 만들기. 화면을 모르는 순수 계산이라 따로 뒀다.
import { makeRound } from './numbers.js?v=8c5da555';
