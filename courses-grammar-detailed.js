         ...
         함정 순서로 가고, 문제는 그다음이다. */
      {
        ...
        blocks: [
          ...
          { t:'cloze', sentence:'나중에 세계 여행을 [가고 싶어요].', answer:'가고 싶어요',
            ...
            options:['갈 거예요','가고 싶어요','가서 싶어요','가겠어요'],
            keys:['가고 싶어요','갈 거예요','가서 싶어요','가겠어요'],
            why:'“나중에” 가 단서입니다. 날짜가 잡힌 일정이 아니라 마음속 바람이므로 -고 싶어요.' },

          { t:'cloze', sentence:'오늘 저녁에는 피자를 [먹고 싶어요].', answer:'먹고 싶어요',
            meaning:'I feel like eating pizza tonight.',
            options:['먹을 거예요','먹으 싶어요','먹고 싶어요','먹었 싶어요'],
            keys:['먹고 싶어요','먹을 거예요','먹으 싶어요','먹었 싶어요'],
            why:'주문을 넣어 둔 것이 아니라 “피자가 당긴다” 는 마음이므로 -고 싶어요. 어간 먹 에 그대로 붙습니다.' },

          { t:'cloze', sentence:'저는 언젠가 한국에서 [살고 싶어요].', answer:'살고 싶어요',
            meaning:'I want to live in Korea someday.',
            options:['살 거예요','살으고 싶어요','살고 싶어요','삽고 싶어요'],
            keys:['살고 싶어요','살 거예요','살으고 싶어요','삽고 싶어요'],
            why:'-고 싶어요 는 받침을 따지지 않습니다. 살 + 고 싶어요 로 그냥 붙어요.' },

          { t:'choice', q:'동생도 같이 가기를 바라고 있어요. 알맞은 것은?',
            options:['동생도 가고 싶어요','동생도 가고 싶어해요','동생도 갈 싶어해요'], answer:1,
            why:'주어가 내가 아니라 동생이므로 -고 싶어하다 를 씁니다.' },
      ...
      /* ── 2강 ────────────────────────────────────────────── */
      {
        ...
        blocks: [
          ...
          { t:'cloze', sentence:'내일 오전 10시에 친구를 [만날 거예요].', answer:'만날 거예요',
            ...
            options:['만나고 싶어요','만난 거예요','만날 거예요','만나야 거예요'],
            keys:['만날 거예요','만나고 싶어요','만난 거예요','만나야 거예요'],
            why:'“내일 10시” 라는 약속이 이미 잡혔습니다. 만나 는 받침이 없으니 ㄹ 거예요.' },

          { t:'cloze', sentence:'올해는 책을 오십 권 [읽을 거예요].', answer:'읽을 거예요',
            meaning:'I am going to read fifty books this year.',
            options:['읽고 싶어요','읽ㄹ 거예요','읽을 거예요','읽는 거예요'],
            keys:['읽을 거예요','읽고 싶어요','읽ㄹ 거예요','읽는 거예요'],
            why:'읽 은 받침 ㄱ 이 있으므로 을 거예요 를 붙입니다.' },

          { t:'cloze', sentence:'다음 달부터 서울에서 [살 거예요].', answer:'살 거예요',
            meaning:'I am going to live in Seoul from next month.',
            options:['살을 거예요','살 거예요','살고 싶어요','사ㄹ 거예요'],
            keys:['살 거예요','살을 거예요','살고 싶어요','사ㄹ 거예요'],
            why:'어간 살 의 받침이 이미 ㄹ 이라 을 을 더 붙이지 않습니다.' },
