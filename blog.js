...
export const BLOG_POSTS = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', title: 'Common arrival mistake: Asking for money exchange', text: 'Learners often try to say 「돈을 바꾸고 싶어요」(I want to exchange money), which sounds unnatural at airport counters. Simply asking 「환전 어디서 해요?」(Where do I exchange money?) or pointing at your currency and saying 「환전해 주세요」(Please exchange this) is much clearer and faster.' },
