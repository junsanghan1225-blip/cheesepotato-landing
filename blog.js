...
export const BLOG_POSTS = [
  {
    ...
    blocks: [
      ...
      { t: 'p', text: 'Because time pressure in the writing section is intense, memorising a predictable structural framework before exam day is the single most reliable way to score 40 points or higher.' },
      ...
      { t: 'p', text: 'If a prompt asks: 1. Why is lifelong learning necessary? 2. What difficulties do adults face when learning? 3. What measures are needed to support them? — your essay must follow this exact sequence across paragraphs 2, 3, and 4.' },
      ...
      { t: 'p', text: 'A reliable formula for your opening sentence is stating a broad social phenomenon: 「최근 우리 사회에서는 ~에 대한 관심이 높아지고 있다」 (Recently in our society, interest in ~ has been rising) or 「현대 사회에서 ~은 중요한 문제로 부각되고 있다」 (In modern society, ~ is emerging as a critical issue).' },
      ...
      { t: 'p', text: 'Close with formal necessity structures such as 「-(으)ㄹ 필요가 있다」 (there is a need to), 「-(으)려고 노력해야 한다」 (efforts must be made to), or 「-는 것이 바람직하다」 (it is desirable that).' },
      ...
      { t: 'list', items: ['Action verbs: -(느)ㄴ다 (생각한다, 발생한다, 증가한다)', 'Descriptive adjectives: -다 without ㄴ/는 (중요하다, 심각하다, 필요하다)', 'Copula nouns: -이다 / -가 아니다 (문제이다, 원인이 아니다)', 'Past tense: -았다/었다 (나타났다, 발전했다)', 'Future and conjecture: -(으)ㄹ 것이다 / -(으)ㄹ 것으로 보인다'], ordered: false },
      { t: 'h', text: 'Mastering the manuscript grid (원고지) layout' },
      { t: 'p', text: 'Writing on manuscript paper follows precise spacing rules that examiners inspect during grading. Violating basic grid formatting costs valuable points even when your text is well written.' },
      { t: 'list', items: ['Indent the very first square of every new paragraph by exactly one blank space', 'Never leave a blank square at the start of normal continuing lines inside a paragraph', 'Place periods, commas, and quotation marks in the bottom-left corner of their own square', 'Write Arabic numbers and Latin letters two per square (e.g. \'20\' or \'AI\' share a single box)', 'If punctuation falls at the end of a line, write it in the margin rather than starting a new line with a period'], ordered: false },
      { t: 'h', text: 'Time allocation strategy for the 50-minute writing section' },
      { t: 'p', text: 'The TOPIK II writing test allows exactly 50 minutes for Questions 51 through 54. Running out of time on Question 54 is the number one cause of failed score goals.' },
      { t: 'list', items: ['Minutes 0 to 10: Complete Question 51 and Question 52 (fill-in-the-blank short questions)', 'Minutes 10 to 25: Complete Question 53 (data and graph description, 200 to 300 characters)', 'Minutes 25 to 30: Outline Question 54 (brainstorm keywords and assign bullet points to paragraphs)', 'Minutes 30 to 48: Write Question 54 steadily on the manuscript grid', 'Minutes 48 to 50: Final proofread for missing particles, spelling errors, and plain-style verb endings'], ordered: true },
      { t: 'h', text: 'Frequently asked questions' },
      { t: 'p', text: 'What happens if I write fewer than 600 characters?' },
      { t: 'p', text: 'The official prompt sets the target length at 600 to 700 characters. If your essay stops short of 600 characters, scorers apply tiered deductions. Essays below 500 characters lose substantial points, and writing under 400 characters risks receiving a zero on the task achievement rubric.' },
      { t: 'p', text: 'Can I use first-person pronouns like 나 or 저?' },
      { t: 'p', text: 'Avoid 「나」, 「저」, and 「우리」 in formal essays. Instead of writing 「제 생각에는」 (In my opinion), phrase your stance objectively: 「~라고 볼 수 있다」 (It can be viewed that ~) or 「~라는 점에 주목해야 한다」 (We must pay attention to the fact that ~). Refer to society as 「현대 사회의 구성원」 or 「사람들」 rather than our group.' },
      { t: 'p', text: 'Should I write a separate title on the top line of the grid?' },
      { t: 'p', text: 'No. Unlike Korean school writing contests, TOPIK Question 54 does not require a title. Begin immediately on the first line with an indented square and your opening introduction sentence. Writing a title wastes valuable manuscript space.' },
      { t: 'h', text: 'Quick self-check quiz' },
      { t: 'p', text: 'Check your knowledge of TOPIK Question 54 essay rules:' },
      { t: 'list', items: ['1. 원고지에서 문단이 바뀔 때 첫 칸은: (비워 둔다 / 채워 쓴다)', '2. 학술 논술문 종결 어미로 알맞은 것은: (중요합니다 / 중요하다 / 중요해요)', '3. 본론 문단을 구성할 때 가장 좋은 기준은: (문제에 제시된 소주제 질문들 / 떠오르는 생각 순서)', '4. 서론을 작성할 때 피해야 할 것은: (문제지 지문 문장 그대로 베껴 쓰기 / 화제 제시하기)'], ordered: true },
      { t: 'note', title: 'Quiz answers and explanations', text: '1. 비워 둔다 — indent the first square of every new paragraph by one block. 2. 중요하다 — adjectives in plain style take -다 directly without ㄴ/는. 3. 문제에 제시된 소주제 질문들 — each sub-question bullet should form its own body paragraph. 4. 문제지 지문 문장 그대로 베껴 쓰기 — copied sentences are excluded from character count.' },
      ...
      { t: 'link', href: '/compare/', title: 'Grammar Comparison Guides', note: 'Explore advanced formal connectors and sentence structures for academic writing' },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'p', text: 'Dropping honorifics too early can cause genuine offense, while clinging to stiff formality with a close friend feels emotionally distant. Understanding the social mechanics behind speech levels is essential for building natural friendships in Korea.' },
      ...
      { t: 'h', text: 'Why Koreans ask your age: the birth-year contract' },
      { t: 'p', text: 'Foreigners often feel caught off guard when a new Korean acquaintance asks 「몇 살이세요?」 (How old are you?) within minutes of meeting. This is not personal nosiness. Korean society uses age to calibrate the linguistic baseline between two speakers.' },
      { t: 'p', text: 'If you were born in the identical year, you are 「동갑」 (peers of the same age). Same-age peers can transition to mutual banmal quite naturally after establishing friendship. If there is an age gap, the younger person generally continues to use polite language unless explicitly told otherwise.' },
      { t: 'h', text: 'How to transition to banmal: the invitation phrases' },
      ...
      { t: 'p', text: 'Common phrases used to lower speech levels include:' },
      { t: 'list', items: ['말 편하게 하세요. (Please speak comfortably / feel free to use casual language.)', '말 놓으셔도 돼요. (You may lower your speech with me.)', '우리 말 놓을까? (Shall we speak casually together? — between same-age peers)', '이제 편하게 불러. (Call me comfortably from now on.)'], ordered: false },
      { t: 'h', text: 'Where banmal is strictly prohibited' },
      { t: 'p', text: 'Even native Korean adults who are close friends refrain from banmal in specific environments. Dropping honorifics in these situations creates awkwardness or professional reprimands.' },
      { t: 'list', items: ['In the workplace: During meetings, client calls, or company presentations, maintain formal or polite speech with colleagues, even if you are best friends outside work', 'With service workers: Always address restaurant waitstaff, taxi drivers, and hotel clerks in polite language; using banmal with customer service staff is considered extremely rude', 'With strangers of any age: Even if someone looks younger than you, address them with -요 until you establish an introduction', 'In university clubs: Senior students (선배) and junior students (후배) typically maintain polite speech until formal club hierarchies allow lowering language'], ordered: false },
      { t: 'h', text: 'Real-world dialogues: negotiating speech levels' },
      { t: 'p', text: 'Here is how two university students break the ice and negotiate their speech style:' },
      { t: 'dlg', lines: ['A: 혹시 몇 년생이세요?', 'B: 저는 2002년생이에요. 혹시 동갑이세요?', 'A: 맞아요! 저도 2002년생이에요. 우리 이제 말 편하게 하자.', 'B: 그래, 좋아! 앞으로 친하게 지내자.'] },
      { t: 'p', text: 'Notice that they begin with full honorifics (몇 년생이세요?). Once they verify they share the exact same birth year, Person A proposes switching with 「우리 이제 말 편하게 하자」, and Person B immediately accepts.' },
      { t: 'h', text: 'Frequently asked questions' },
      { t: 'p', text: 'Can I use banmal with someone younger than me right away?' },
      { t: 'p', text: 'No. Unless the person is an obvious young child (under 10), speaking uninvited banmal to an adult simply because they are a few years younger sounds arrogant. Adult strangers always deserve polite speech.' },
      { t: 'p', text: 'What if someone speaks banmal to me first?' },
      { t: 'p', text: 'If an older person or colleague speaks banmal to you, do not automatically mirror it back. In Korean relationships, asymmetric speech levels are common: an older mentor may speak banmal to you while you respond in jondaetmal. Only speak banmal back if they explicitly invite you to speak mutually comfortably.' },
      { t: 'p', text: 'Why do some married couples speak polite Korean to each other?' },
      { t: 'p', text: 'Many modern Korean couples choose to maintain mutual 해요체 (-아요/어요) even after decades of marriage. They find that polite speech prevents heated arguments, preserves emotional respect, and models courteous behavior for their children.' },
      { t: 'h', text: 'Quick self-check quiz' },
      { t: 'p', text: 'Determine whether casual speech (반말) is appropriate in each scenario:' },
      { t: 'list', items: ['1. 식당에서 아르바이트생에게 물을 달라고 할 때: (반말 / 존댓말)', '2. 회사 공식 회의에서 입사 동기이자 친구에게 발언할 때: (반말 / 존댓말)', '3. 대학 축제에서 처음 만난 동갑내기 친구와 합의 후 이야기할 때: (반말 / 존댓말)', '4. 동아리 선배가 \'말 편하게 해\'라고 했을 때 혼자 바로 반말을 쓸지: (상대에게 확인 후 신중히 사용 / 즉시 반말)'], ordered: true },
      { t: 'note', title: 'Quiz answers and explanations', text: '1. 존댓말 — service staff must always be addressed politely. 2. 존댓말 — professional settings demand formality regardless of private friendship. 3. 반말 — same-age peers who mutually agree to lower language. 4. 상대에게 확인 후 신중히 사용 — junior students usually ease into softened polite speech rather than jumping abruptly to pure banmal.' },
      ...
      { t: 'link', href: '/compare/', title: 'Grammar Comparison Guides', note: 'Explore comparisons between casual speech, polite style, and formal honorifics' },
    ],
  },
  {
    ...
    blocks: [
      { t: 'p', text: 'Commercial Korean courses often charge hefty monthly subscriptions, and purchasing individual textbooks for every single level quickly adds up. Preparing from complete beginner all the way to TOPIK Level 6 without spending money is entirely possible. This guide is not marketing copy; it details the specific free learning tools available on this platform and explains how to use them in a logical sequence so that each stage builds on the previous one rather than leaving gaps.' },
      { t: 'h', text: 'Step 1: From Hangul to structured sentences' },
      { t: 'p', text: 'If you cannot read the alphabet yet, begin with the Read Korean course. Hangul was engineered to be learned quickly: King Sejong designed it in the fifteenth century with the explicit goal that ordinary people should be able to learn it within a few days. The course walks through vowels, consonants, and syllable construction systematically, with native audio attached to every combination so you build correct pronunciation habits from the start rather than learning bad habits from romanised spellings.' },
      { t: 'p', text: 'Once you can sound out any word, move through the introductory grammar courses. These cover survival greetings, ordering food, asking for directions, and the basic mechanics of Korean sentences: the role of particles, how verbs conjugate, and why Korean sentences end with the verb instead of beginning with it. These foundational habits matter because the writing section of TOPIK II expects you to construct sentences naturally, not to translate English patterns word for word.' },
      { t: 'link', href: '/course/', title: 'Interactive Courses', note: 'Explore structured courses covering beginner through advanced grammar in bite-sized lessons' },
      { t: 'h', text: 'Step 2: Master 290 grammar patterns in context' },
      { t: 'p', text: 'Memorising isolated grammar rules breaks down as you reach intermediate and advanced levels. A rule that works in isolation often needs adjustment when it meets another grammar pattern. In real communication, subtle nuances distinguish seemingly similar endings — for example, -(으)ㄹ 것이다 sounds like a neutral prediction, while -(으)ㄹ 텐데 signals that the speaker expects a specific result based on prior knowledge. TOPIK II reading passages rely heavily on these distinctions.' },
      { t: 'p', text: 'The sentence builder on this site includes 290 essential grammar points across beginner, intermediate, and advanced tiers. Each point comes with clear definitions, natural example sentences, and interactive drills where you write your own sentences rather than merely skimming a rule. Writing practice turns passive recognition into active production — exactly what the essay questions on TOPIK II demand.' },
      { t: 'gram', id: '42-3', note: 'Describe how your Korean reading ability gradually improves as you accumulate practice hours' },
      { t: 'p', text: 'Work through the grammar points in level order. Do not skip ahead to advanced patterns until the intermediate ones feel automatic. The TOPIK II reading section expects you to identify grammar in complex contexts, and that only happens when the underlying patterns are already familiar enough that you do not need to actively puzzle them out.' },
      ...
      { t: 'p', text: 'To be completely transparent, the questions on this site are original practice exercises written to match official TOPIK patterns, not leaked past exam papers. Every reading and listening question comes with line-by-line answer explanations, and essay questions provide model answers with analytical scoring rubrics that explain why particular phrasing receives full marks and why common learner mistakes lose points.' },
      { t: 'list', items: ['TOPIK Reading: Work through short announcements, news editorials, and long narrative passages. Every unfamiliar vocabulary item links to an instant glossary lookup so you do not lose momentum mid-passage.', 'TOPIK Listening: Listen to realistic dialogues recorded at official test tempo. Synchronous scripts let you follow along and identify exactly where your comprehension broke down so you can target that specific pattern.', 'TOPIK Writing: Question 53 asks you to complete a short passage. Question 54 asks you to write an argumentative essay of 600 to 700 characters. Both question types require grammatical range and vocabulary appropriate to the written register, which is more formal than conversational Korean.'], ordered: false },
      { t: 'gram', id: '38-2', note: 'Express intention and purpose when describing why you are training with each question type' },
      { t: 'p', text: 'When practising essay writing, study the model answers carefully before drafting your own. Notice how strong answers use connecting expressions to link paragraphs, how they balance both sides of an argument before stating a conclusion, and how they avoid casual speech endings. These are patterns you can learn systematically rather than hoping they appear naturally.' },
      ...
      { t: 'p', text: 'Most learners who fall short of Level 6 do not fail because study material is unavailable. They fall short because they stop studying after two or three weeks when the initial excitement fades. Steady daily habits matter far more than weekend study marathons followed by days of inactivity. The brain consolidates new language patterns during sleep and downtime, so spreading practice across more days produces stronger retention than cramming the same total hours into fewer sessions.' },
      { t: 'gram', id: '41-2', note: 'Turn verbs into nouns to track daily habits like reading Korean and reviewing grammar' },
      { t: 'p', text: 'Build a daily rhythm that fits your actual schedule rather than an ideal one. Solve three reading passages in the morning, review five grammar points during your commute, and draft one short writing outline in the evening. Even thirty minutes of focused practice each day adds up to over 180 hours across a year — more than enough to move from beginner to advanced if the practice is deliberate rather than passive.' },
      { t: 'h', text: 'What free actually means here' },
      { t: 'p', text: 'Every resource linked in this guide is available without registration or payment. No premium tier unlocks grammar points that the free version hides. No listening questions are paywalled. The courses, the grammar drills, the reading passages, and the essay practice are all open. The only investment required is time — and for TOPIK Level 6, that investment is measured in months of consistent practice, not in hundreds of dollars of course fees.' },
      { t: 'link', href: '/topik-reading/', title: 'TOPIK Reading Practice', note: 'Passages at every TOPIK difficulty level with vocabulary notes and answer explanations' },
      { t: 'link', href: '/topik-listening/', title: 'TOPIK Listening Practice', note: 'Dialogues recorded at authentic test speed with full transcripts' },
    ],
  },
  {
    ...
    blocks: [
      { t: 'p', text: 'Setting a goal like "I want to be good at Korean" often leads to burnout because there is no finish line. The Test of Proficiency in Korean, commonly known as TOPIK, provides clear benchmarks that give your study a direction. Even if you never plan to submit a TOPIK certificate to a university or employer, understanding how the level system works helps you measure realistic progress and choose appropriate study material at each stage.' },
      { t: 'h', text: 'You choose the exam, not the level' },
      { t: 'p', text: 'A common misconception among beginners is that you register for a specific grade, such as Level 3. In reality, there are only two separate examinations offered, and your score on the day determines which level appears on your certificate.' },
      { t: 'list', items: ['TOPIK I: Evaluates beginner ability through 30 listening questions and 40 reading questions. Based on your combined score, you receive either Level 1 or Level 2. There is no writing section in TOPIK I whatsoever.', 'TOPIK II: Evaluates intermediate to advanced ability through 50 listening questions, 4 essay and sentence-writing tasks, and 50 reading questions. Depending on your final score, you receive Level 3, 4, 5, or 6. The same exam determines all four outcomes.'], ordered: false },
      { t: 'p', text: 'This structure has a practical implication: if you are aiming for Level 5 or 6, you cannot simply "try for Level 5" in isolation. You register for TOPIK II and hope your performance that day clears the threshold for Level 5 rather than landing in Level 4. Planning around score thresholds is therefore more useful than planning around level labels alone.' },
      { t: 'gram', id: '39-2', note: 'Use this pattern when setting score prerequisites for a target certificate level' },
      { t: 'h', text: 'Score thresholds for each level' },
      { t: 'p', text: 'The TOPIK exam is scored out of 300 points. Levels are awarded based on the following approximate thresholds, which have remained broadly consistent across recent administrations. Always verify with the official TOPIK announcement before your registration date.' },
      { t: 'list', items: ['Level 1: TOPIK I, 80 points and above', 'Level 2: TOPIK I, 140 points and above', 'Level 3: TOPIK II, 120 points and above', 'Level 4: TOPIK II, 150 points and above', 'Level 5: TOPIK II, 190 points and above', 'Level 6: TOPIK II, 230 points and above'], ordered: false },
      { t: 'h', text: 'Common benchmarks for real-world goals' },
      { t: 'p', text: 'Requirements vary widely by institution and change over time. Always check the official website of the university or employer you are applying to rather than relying on summaries written months earlier. The following reflects how levels are commonly used in practice across Korea.' },
      { t: 'list', items: ['Undergraduate admissions: Most Korean universities set Level 3 as the minimum requirement for admission, with many academic programmes recommending Level 4 for students who need to attend lectures taught entirely in Korean.', 'Graduation requirements: Universities often ask international students to advance one level above their entry score before graduating. A student admitted with Level 3 is typically expected to obtain Level 4 before receiving a degree.', 'Graduate school: Level 4 or 5 is standard depending on the academic field. Programmes taught in English may waive the requirement, but Korean-language programmes often set Level 5 as a strict prerequisite.', 'Employment: Companies hiring for roles where Korean communication is essential typically look for Level 4 or higher. Some professional roles in government and finance specify Level 5.', 'Visa and immigration: Points-based criteria change frequently. Check official immigration announcements directly rather than third-party blogs, as many such posts describe eligibility requirements that have since changed.'], ordered: false },
      ...
      { t: 'p', text: 'If you do not have a specific deadline from an employer or university, Level 4 is the most practical default target for most learners. Level 4 marks the threshold where you can understand news articles, follow structured academic discussions, and handle everyday professional interactions without relying on a dictionary at every turn. It represents genuine communicative independence rather than just tourist-level survival ability.' },
      { t: 'p', text: 'Level 6 is a realistic long-term target for motivated learners who plan to work or study in Korea, but it should be approached after Level 4 is stable. Jumping straight from beginner material into TOPIK II preparation wastes study time because the gap between Level 2 and Level 3 is considerable. Building a strong foundation in reading and grammar first makes the later jump to Level 5 and 6 much more efficient.' },
      ...
      { t: 'h', text: 'How to build toward your target level' },
      { t: 'p', text: 'Identify your current approximate level honestly. If you cannot read Korean comfortably, begin with the Hangul course and foundational grammar before attempting any practice questions. If you can already handle short passages but lose comprehension in longer ones, focus on building vocabulary range and practising the longer reading formats that appear in TOPIK II.' },
      { t: 'gram', id: '38-5', note: 'Express deciding on a concrete study schedule aligned to your target level' },
      { t: 'p', text: 'TOPIK is offered several times a year overseas and more frequently inside Korea. Registration windows close weeks before the exam date, and the schedule varies by country. Build your study timeline around the next available exam date that is realistically achievable rather than the nearest one that is only weeks away. Attempting TOPIK II before your vocabulary and grammar are solid enough for Level 3 is unlikely to yield the score you need and costs both money and confidence.' },
      { t: 'p', text: 'Choose your target level, verify the current registration dates on the official TOPIK website, and work backward to build a weekly study plan that reaches your target score before the exam date. Consistent daily practice over several months beats intensive last-minute cramming at every proficiency level.' },
      { t: 'link', href: '/course/', title: 'Interactive Courses', note: 'Start from Hangul or jump into intermediate grammar with structured lessons' },
      { t: 'link', href: '/sentence/', title: '290 Grammar Patterns', note: 'Build active writing skill with interactive sentence drills at every level' },
    ],
  },
  {
    ...
    blocks: [
      ...
      { t: 'p', text: 'Hangul is different. King Sejong and his scholars designed it in 1443 and published it in 1446. The explicit design goal was that ordinary people should be able to learn it in a few days. The shapes of the letters reflect that design philosophy directly, which is why the system feels learnable in a way that random letter shapes do not.' },
      { t: 'list', items: ['The five basic consonants mirror speech organs: 「ㄱ」 shows the tongue root blocking the throat, 「ㄴ」 shows the tongue tip touching the upper gums, 「ㅁ」 outlines the mouth, 「ㅅ」 depicts the teeth, and 「ㅇ」 represents the throat.', 'Adding a stroke strengthens the sound: 「ㄱ」 becomes 「ㅋ」, 「ㄴ」 becomes 「ㄷ」 then 「ㅌ」, 「ㅁ」 becomes 「ㅂ」 then 「ㅍ」, and 「ㅅ」 becomes 「ㅈ」 then 「ㅊ」. You do not memorise unrelated shapes; you add a single stroke.', 'Doubling a letter creates a tense consonant: 「ㄲ」, 「ㄸ」, 「ㅃ」, 「ㅆ」, 「ㅉ」. The rule is visible at a glance — two of the same character equals the tense version.', 'Vowels are built from three components: a horizontal line, a vertical line, and a short tick. Adding a second tick adds a y sound: 「ㅏ」 becomes 「ㅑ」, and 「ㅓ」 becomes 「ㅕ」.'], ordered: false },
      { t: 'p', text: 'You do not memorise forty random shapes. You learn five base shapes and two simple rules about how strokes extend them. That is why one morning is genuinely enough to understand the alphabet on paper and decode unfamiliar syllables by sounding them out.' },
      { t: 'h', text: 'Letters sit in syllable blocks' },
      { t: 'p', text: 'Unlike English letters written in a continuous linear row, Korean letters assemble into neat square blocks. Each block corresponds to exactly one spoken syllable. The consonant 「ㅎ」, vowel 「ㅏ」, and final consonant 「ㄴ」 assemble together as 「한」. The word 한국어 (Korean language) contains three blocks and three syllables.' },
      { t: 'p', text: 'Beginners sometimes find this arrangement unfamiliar at first because no European writing system organises letters this way. But it actually speeds up reading once you get used to it. Because every block is one rhythmic beat, your eyes can easily see where syllables begin and end, which removes the ambiguity that plagues learners of English about where word stress falls.' },
      ...
      { t: 'p', text: 'Here is the honest part that short online videos typically omit. Recognising twenty-four letters and understanding how they combine into syllable blocks is not the same as fluent reading. Real Korean speech involves a set of pronunciation rules where written letters change their sound when they meet adjacent sounds in a word. These rules are completely regular and can be learned, but they cannot be absorbed in three hours.' },
      { t: 'list', items: ['Final consonants carry over into following vowels: 「한국어」 is written with 「국」 and 「어」 as separate blocks, but spoken as [한구거] because the ㄱ of 국 links to the following vowel.', 'The consonant 「ㅎ」 softens or disappears between voiced sounds: 「좋아요」 is pronounced [조아요] because the ㅎ between two voiced sounds weakens and disappears.', 'Certain consonants assimilate to match their neighbours: 「신라」 is pronounced [실라], and 「학년」 is pronounced [항년] because consonants change to match the sounds beside them.'], ordered: false },
      { t: 'p', text: 'These assimilation rules cannot be absorbed in three hours. Expecting to read street signs fluently on day one leads to needless frustration, not because Hangul is difficult but because the pronunciation layer on top of the written system requires separate practice with audio.' },
      ...
      { t: 'p', text: 'If you plan your first month with realistic expectations, Korean feels far more manageable than the ambitious claims on YouTube suggest. The timeline below is not a guarantee — individual variation is significant — but it reflects what most learners who practice daily report.' },
      { t: 'list', items: ['Morning 1 (3 hours): Memorise basic consonants, basic vowels, and how to combine them into simple syllables without final consonants.', 'Days 2 to 4: Practice final consonants (받침) and simple batchim combinations. Start using audio from the beginning so your eyes and ears connect the written and spoken forms together.', 'Weeks 2 to 3: Read short words aloud alongside audio recordings to pick up sound change patterns naturally. Do not try to memorise the rules abstractly; let the audio examples build the habit.', 'Week 4: Read full sentences slowly without relying on romanised spellings. At this point most learners can decode any written Korean word, even if they do not know its meaning.'], ordered: true },
      { t: 'gram', id: '39-1', note: 'Connect study conditions and expected outcomes naturally — useful for describing your own learning plan' },
      { t: 'p', text: 'Never rely on romanisation such as guk or annyeong as a learning crutch. Roman letters map poorly onto Korean phonemes — the romanisation system was designed for non-learners to approximate sounds, not to help learners build accurate reading habits. Romanisation also slows down your reading speed because you are decoding through a second layer instead of reading the actual script directly. Spend your first morning with the actual alphabet, and leave the sound change rules for the weeks ahead when you have audio to guide you.' },
  ...
  },
  {
    ...
    title: 'Travel Korean survival guide: 40 phrases that actually matter',
    date: '2026-09-20',
    updated: '2026-09-23',
    tags: ['English', 'Travel'],
    excerpt: 'Tourist phrasebooks list hundreds of sentences that never come up. This guide cuts it down to the 40 phrases Korean locals actually use in the situations visitors encounter most.',
    blocks: [
      { t: 'p', text: 'Standard Korean phrasebooks are often printed with 300 or more sentences covering situations a tourist encounters perhaps once a decade. This guide takes a different approach. It focuses on the phrases that appear in the most common travel scenarios — arriving, getting around, eating, and paying — and explains the structure behind each phrase so you can adapt it when the situation varies slightly.' },
      { t: 'h', text: 'Before you land: three things worth knowing' },
      { t: 'p', text: 'First, Korean has two speech levels you will encounter constantly. 주세요 (juseyo) is polite and safe for all situations with strangers. 해요 endings are informal but still polite. You do not need to worry about other levels during a short trip; 주세요 handles almost every request you will make.' },
      { t: 'p', text: 'Second, pointing and gesturing work well. Korean speakers are generally patient with foreign visitors who look confused. A polite 이거 주세요 (igeo juseyo — this one, please) combined with pointing gets results in almost any shop or restaurant.' },
      { t: 'p', text: 'Third, Naver Maps works better than Google Maps for Korean addresses. Download it before you land. Many locations that appear incorrectly on Google Maps are accurate on Naver.' },
      { t: 'h', text: 'Arriving and directions' },
      { t: 'list', items: ['어디예요? (Eodi-yeyo?) — Where is it? Combine with a place name: 화장실 어디예요? means Where is the toilet?', '지하철역 어디예요? (Jihacheolyeok eodi-yeyo?) — Where is the subway station?', '얼마나 걸려요? (Eolmana geollyeoyo?) — How long does it take?', '여기서 걸어서 갈 수 있어요? (Yeogiseo georeo ga-l su isseoyo?) — Can I walk there from here?', '택시 불러주세요 (Taeksi bulleo-juseyo) — Please call a taxi for me.'], ordered: false },
      { t: 'gram', id: '34-1', note: 'The -(으)면 돼요 pattern covers asking whether something is allowed or sufficient, which comes up constantly at checkpoints and counters' },
      { t: 'h', text: 'At restaurants' },
      { t: 'p', text: 'Korean restaurants often use automated ordering tablets or QR codes, but staff still handle questions. The phrases below cover the most common situations.' },
      { t: 'list', items: ['이거 주세요 (Igeo juseyo) — This one, please. The single most useful phrase in any menu situation.', '몇 명이에요? (Myeot myeong-ieyo?) — How many people? Staff often ask this. Answer with a number: 두 명이요 means two people.', '매워요? (Maewoyo?) — Is it spicy?', '맵지 않게 해주세요 (Maepji ank-e haejuseyo) — Please make it not spicy.', '물 주세요 (Mul juseyo) — Water, please. Tap water is usually free and safe to drink.', '영수증 주세요 (Yeongsujeung juseyo) — Please give me a receipt.', '포장이요 (Pojangieyo) — Takeaway, please. Say this instead of 여기서 먹을게요 (Yeogiseo meogeulgeyo — I will eat here) when ordering at a counter.'], ordered: false },
      { t: 'h', text: 'Shopping and paying' },
      { t: 'list', items: ['얼마예요? (Eolmayeyo?) — How much is it?', '이거 있어요? (Igeo isseoyo?) — Do you have this? Useful when pointing at a photo on your phone.', '카드 돼요? (Kadeu dwaeyo?) — Can I pay by card?', '좀 깎아주세요 (Jom kkakka-juseyo) — A small discount, please. Use only at markets and street stalls, never in regular shops.', '영어 메뉴 있어요? (Yeongeo menyu isseoyo?) — Do you have an English menu?', '이거 뭐예요? (Igeo mwo-yeyo?) — What is this? Point at something unfamiliar.'], ordered: false },
      { t: 'gram', id: '34-2', note: '면 안 돼요 tells you something is not allowed — useful for understanding posted rules and staff refusals' },
      { t: 'h', text: 'At accommodation' },
      { t: 'list', items: ['체크인 하려고요 (Chekeu-in haryeogoyo) — I would like to check in.', '예약했어요 (Yeyakhaesseoyo) — I have a reservation.', '방이 너무 더워요 / 추워요 (Bang-i neomu deowoyo / chuwoyo) — The room is too hot / too cold.', '와이파이 비밀번호가 뭐예요? (Waipai bimilbeonhoga mwoyeyo?) — What is the Wi-Fi password?', '몇 시에 체크아웃 해야 돼요? (Myeot si-e chekeu-aut haeya dwaeyo?) — What time do I need to check out?'], ordered: false },
      { t: 'h', text: 'Using public transport' },
      { t: 'p', text: 'Seoul and most major Korean cities have extensive subway networks with English signage on every platform. The T-money card is the simplest payment method: top it up at any convenience store and tap in and out at turnstiles. It also works on buses and taxis in most cities.' },
      { t: 'list', items: ['이 버스 어디까지 가요? (I beoseu eodi-kkaji gayo?) — Where does this bus go?', '내려주세요 (Naeryeo-juseyo) — Please let me off here. Say this to a taxi driver.', '공항까지 얼마예요? (Gonghang-kkaji eolmayeyo?) — How much to the airport?', '미터기로 가주세요 (Miteo-gi-ro ga-juseyo) — Please use the meter. Always say this before settling into a taxi.', '이 역 맞아요? (I yeok maja-yo?) — Is this the right station?'], ordered: false },
      { t: 'h', text: 'At convenience stores and cafés' },
      { t: 'p', text: 'Korean convenience stores — GS25, CU, and 7-Eleven — are open around the clock and sell hot food, coffee, seating, and phone chargers. They are also useful for phone top-ups, printing, and ATM withdrawals from international cards.' },
      { t: 'list', items: ['데워주세요 (Dewo-juseyo) — Please heat this up. Staff at convenience stores will use the in-store microwave.', '봉투 주세요 (Bongtu juseyo) — A bag, please.', '아이스로 주세요 (Aiseu-ro juseyo) — Cold, please. Use when ordering iced drinks at a café counter.', '사이즈가 어떻게 돼요? (Saijeu-ga eotteoke dwaeyo?) — What sizes do you have?'], ordered: false },
      { t: 'h', text: 'Polite fallbacks' },
      { t: 'p', text: 'Even if your Korean runs out, two phrases keep interactions civil. 잠깐만요 (Jamkkanmanyo) means just a moment and buys you time to look something up. 죄송합니다 (Joesonghamnida) is a formal apology that works whenever you have bumped into someone, misheard something, or made a mistake. Korean speakers will appreciate the effort regardless of your pronunciation.' },
      { t: 'p', text: 'If you want to expand beyond survival phrases before your trip, the courses below introduce the grammar structures behind these sentences so that you can adjust them flexibly rather than relying on memorised scripts that break the moment the situation changes slightly.' },
      { t: 'link', href: '/course/first-words.html', title: 'First Words Course', note: 'Learn the vocabulary and short sentences that appear most often in everyday Korean' },
      { t: 'link', href: '/course/', title: 'All Interactive Courses', note: 'Structured lessons from Hangul through intermediate grammar with audio' },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      { t: 'p', text: '「저는 학생이에요」 and 「제가 학생이에요」 are both correct sentences that mean different things. This is the question Korean learners ask most, and most answers hand you a list of ten rules. The list does not help when you are actually writing a sentence, because each item on the list covers a different situation and none of them tell you which to apply when the situation you are in does not match any example cleanly.' },
      ...
      { t: 'p', text: 'The first two sentences of any Korean folk tale show this more clearly than any grammar explanation.' },
      { t: 'quote', lines: ['옛날에 한 할아버지**가** 살았습니다.', '그 할아버지**는** 매일 산에 나무를 하러 갔습니다.'] },
      { t: 'p', text: 'In the first sentence the old man appears for the first time — 이/가. By the second sentence he is someone we both know about — 은/는. Swap them and the first sentence sounds wrong, because 은/는 treats a stranger as though you already knew him. Folk tales follow this rule without exception because it mirrors how all Korean discourse introduces and maintains topics.' },
      { t: 'p', text: 'This is why introducing yourself is 「저**는** 학생이에요」. You are not new information — you are standing right there. 「제**가** 학생이에요」 is closer to 「**I** am the student」, carrying the specific implication that you are identifying which person among several is the student. Outside that context it sounds odd, even to native speakers who could not explain why.' },
      ...
      { t: 'p', text: 'Question words make the rule visible and testable. When a question asks about something unknown, the unknown slot takes 이/가. The answer fills that same slot, so it also takes 이/가. When a question is about a known topic, the topic takes 은/는.' },
      { t: 'quote', lines: ['누**가** 왔어요? — 제임스**가** 왔어요.', '제임스**는** 왔어요? — 네, 제임스**는** 왔어요.'] },
      { t: 'p', text: '「누가」 asks about something unknown — the identity of the person — so 이/가. The answer fills the same unknown slot, so 이/가. 「제임스는 왔어요?」 is what you ask when James is already the established topic and you only want to confirm whether he showed up. The question and answer share the same discourse position, and that position determines the particle.' },
      { t: 'h', text: '은/는 is closer to 「as for」' },
      { t: 'p', text: 'If you read 은/는 as 「as for」, contrast falls out on its own without needing a separate rule for it.' },
      { t: 'ex', ko: '커피는 좋아하는데 우유는 싫어해요.', en: 'As for coffee I like it, but as for milk I do not.' },
      { t: 'p', text: 'Two things are being weighed against each other, so both take 은/는. Using 이/가 here breaks the comparison because 이/가 would introduce each item as if it had never been mentioned, which clashes with the structure of the contrast.' },
      { t: 'note', title: 'The part that surprises people', text: '은/는 drags in what you did **not** say. 「저는 김치**는** 먹어요」 lands as 「I eat kimchi — *unlike some other thing*」, and the listener will assume there is something you cannot eat. If you did not mean that, say 「김치**를** 먹어요」. This catches learners constantly because you can make a sentence grammatically correct and culturally misleading at the same time.' },
      { t: 'gram', id: '26-2', note: 'Worth reading the watch-out section here specifically — the implied contrast is the part that causes real misunderstandings in everyday conversation' },
      { t: 'h', text: 'Inside a modifying clause, only 이/가 is possible' },
      { t: 'p', text: 'Everything above is about nuance and discourse position. This part is a hard grammatical rule with no exceptions. The subject of a clause that modifies a noun must take 이/가, regardless of whether that subject is new or old information.' },
      { t: 'quote', lines: ['제**가** 만든 음식 (correct)', '저**는** 만든 음식 (not possible)'] },
      { t: 'p', text: '「제가 좋아하는 노래」, 「비**가** 오는 날」, 「사람**이** 많은 곳」 — all the same slot. Learners hit this constantly once sentences get longer, not because the rule is hard to understand but because the habit of starting sentences with 「저는」 follows them automatically into the modifying clause, where 은/는 is simply not available.' },
      ...
      { t: 'p', text: 'Knowing the rules does not make the right particle come out when you are speaking. This is a case where the gap between recognising and producing is unusually wide. You can pass a multiple-choice quiz on this topic and still reach for the wrong particle the moment you are composing a real sentence, because comprehension activates a different mental pathway than production does.' },
      { t: 'p', text: 'The fastest way to close that gap is to write your own sentences — full sentences describing something real about your day — and notice which particle you reached for first and why. Start with simple first-mention sentences using 이/가: 오늘 친구**가** 왔어요. Then practice topic sentences using 은/는: 그 친구**는** 서울에서 왔어요. Then try contrast: 저**는** 커피는 좋아하는데 차**는** 별로예요. Writing this way builds the habit faster than any amount of reading about the rule.' },
