...
export const BLOG_POSTS = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'ex', ko: '제가 직접 먹어 보니까 아주 맛있더라고요.', en: 'I tasted it myself, and found it delicious.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'list', items: ['**Tier 1: Easy (Keywords)** — Single words or ultra-short phrases. If you freeze up, just saying the keyword with a questioning tone gets your point across immediately.', '**Tier 2: Standard (Polite 해요체)** — The universal sweet spot. Polite, friendly, and respectful. Use this in 95% of everyday interactions with store clerks, hotel staff, and taxi drivers.', '**Tier 3: Accurate (Formal & Polite)** — Complete, idiomatic sentences with proper honorific particles. Perfect when you want to sound polished or when filling out official forms.'], ordered: false },
      ...
      { t: 'h', text: 'Key pronunciation tip: Linking and sound changes' },
      { t: 'p', text: 'Before memorizing phrases, keep three simple pronunciation rules in mind so that locals understand you on the first try. First, 「감사합니다」(Thank you) is pronounced [감사함니다] because ㅂ sounds like ㅁ before ㄴ. Second, consonants at the end of a syllable block slide over into the next syllable when it begins with ㅇ — so 「얼마예요」 sounds like [얼마예요] and 「화장실 어디예요」 flows smoothly together. Third, speak rhythmically beat by beat rather than sliding vowels together like in English.' },
      ...
      { t: 'dlg', lines: ['A: 여권 보여주시겠어요?', 'B: 네, 여기 여권이요.'] },
      { t: 'note', title: 'Money exchange: the word counters use', text: '「돈을 바꾸고 싶어요」(I want to change money) is perfectly fine Korean, but at the airport the word on every sign is 「환전」(currency exchange). Asking 「환전 어디서 해요?」(Where can I exchange money?), or pointing at your cash and saying 「환전해 주세요」(Please exchange this), matches what staff expect to hear.' },
      ...
      { t: 'dlg', lines: ['A: 어디로 가세요?', 'B: 명동역 가주세요. (To Myeongdong station, please.)'] },
      { t: 'note', title: 'Subway tip: Exit numbers and card tap', text: 'Seoul subway stations are huge, and destinations are always marked by exit number rather than street name. When asking for directions, ask for the exit number: 「몇 번 출구예요?」(Which exit is it?). Always tap your T-money card when boarding and getting off buses to avoid maximum fare penalties.' },
      { t: 'ex', ko: '몇 번 출구예요?', en: 'Which exit is it? (Standard)' },
      ...
      { t: 'list', items: ['**Calling staff:** 「저기요!」(Excuse me!) — Raise your hand slightly and say this clearly.', '**Ordering:** 「이거 하나 주세요」(One of this, please).', '**Controlling spice:** 「안 맵게 해주세요」(Please make it not spicy) or 「덜 맵게 해주세요」(Less spicy, please).', '**Side dish refill:** 「반찬 더 주세요」(More side dishes, please — standard side dishes in Korea are free to refill!).', '**Bill:** 「계산해 주세요」(Bill, please).'], ordered: false },
      { t: 'gram', id: '30-1', note: '-(으)세요 is the foundation of polite requests in restaurants: 「물 주세요」(Water please), 「메뉴판 주세요」(Menu please).' },
      { t: 'p', text: 'Korean dining culture has a few unique customs. You do not need to wait by the door in casual restaurants; find an open table and sit down. Spoons, chopsticks, and napkins are usually kept in a hidden drawer on the side of the table under the tabletop. Water and additional kimchi are often self-service (셀프).' },
      { t: 'dlg', lines: ['A: 주문하시겠어요?', 'B: 네, 비빔밥 하나 주세요.'] },
      { t: 'ex', ko: '물은 셀프예요?', en: 'Is water self-service? (Standard)' },
      ...
      { t: 'p', text: 'In major shopping areas like Myeongdong, Seongsu, and Hongdae, shops offer immediate tax refunds at the checkout counter. Keep your physical passport with you while shopping, as photos on your phone are not accepted for tax-free processing.' },
      ...
      { t: 'h', text: '6. Hotel & Accommodation (호텔 & 숙소)' },
      { t: 'p', text: 'Hotel staff at international chains speak English, but boutique hotels, guesthouses, and Hanok stays often have Korean-speaking front desk hosts. These phrases ensure smooth check-in and check-out:' },
      { t: 'ex', ko: '체크인 하려고요.', en: 'I would like to check in. (Standard)' },
      { t: 'ex', ko: '짐을 맡길 수 있을까요?', en: 'Could I leave my luggage here? (Accurate)' },
      { t: 'ex', ko: '와이파이 비밀번호가 뭐예요?', en: 'What is the Wi-Fi password? (Standard)' },
      { t: 'dlg', lines: ['A: 예약자 성함이 어떻게 되세요?', 'B: 제임스입니다. 여기 여권이요.'] },
      { t: 'h', text: 'Frequently Asked Questions for Korea Travelers' },
      { t: 'h', text: 'Do I need to speak Korean to travel in Seoul?' },
      { t: 'p', text: 'No, you do not need to be fluent. Subway signs, announcements, ticket machines, and major tourist spots all have clear English translations. However, knowing the survival phrases in this guide makes your trip significantly smoother when taking taxis, ordering at neighbourhood restaurants, or visiting traditional markets where English is rarely spoken.' },
      { t: 'h', text: 'Is English widely spoken in Korea?' },
      { t: 'p', text: 'Younger Koreans and staff at airport desks, brand hotels, and tourist boutiques often speak conversational English. In local eateries, street stalls, and neighbourhood convenience stores, staff usually understand only basic English keywords. Having polite Korean phrases ready shows respect and gets you much warmer service.' },
      { t: 'h', text: 'Can I pay with credit cards everywhere in Korea?' },
      { t: 'p', text: 'South Korea is one of the most cashless societies in the world. Visa and Mastercard are accepted at virtually every café, restaurant, convenience store, and taxi. The only situations where physical cash is required are traditional street food stalls (like Gwangjang Market) and topping up transit cards (T-money) at subway station machines.' },
      { t: 'h', text: 'What is the single most useful Korean phrase?' },
      { t: 'p', text: 'The absolute golden phrase is 「이거 주세요」(This one, please). Paired with pointing at a menu item or a physical object, it solves 80% of your daily purchasing interactions across Korea.' },
      { t: 'h', text: 'Five phrases to memorize before boarding' },
      { t: 'list', items: ['**1. 안녕하세요** (Annyeonghaseyo) — Hello / Good morning / Good evening.', '**2. 감사합니다** (Gamsahamnida) — Thank you.', '**3. 저기요** (Jeogiyo) — Excuse me (to get attention in restaurants).', '**4. 이거 주세요** (Igeo juseyo) — This one, please.', '**5. 화장실 어디예요?** (Hwajangsil eodiyeyo?) — Where is the restroom?'], ordered: true },
