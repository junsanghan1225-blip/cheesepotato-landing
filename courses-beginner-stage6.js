  ...
  /* ── 2 ─────────────────────────────────────────────────── */
  {
    ...
    blocks: [
      ...
      { t:'table', head:['Grammar Pattern','Modifier Piece','Noun / Ending Behind It','What It Literally Means'], rows:[
        ...
        ['**-(으)ㄹ까요** (Shall we?)','**-(으)ㄹ** (future modifier)','**-까** (a fused question ending — not a stand-alone noun like the others) + **요** (polite)','“Built on the same future modifier, asked as a question”'],
