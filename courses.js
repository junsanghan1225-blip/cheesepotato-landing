...
import { GRAMMAR_COURSES } from './courses-grammar.js?v=45f0aade';
import { DETAILED_GRAMMAR_COURSES } from './courses-grammar-detailed.js?v=45f0aade';
import { BEGINNER_GRAMMAR_COURSES } from './courses-grammar-beginner.js?v=45f0aade';
// 초급 1단계 — 설계는 docs/curriculum-beginner.md
import { BEGINNER_STAGE1_COURSES } from './courses-beginner-stage1.js?v=45f0aade';
