...
import { GRAMMAR_COURSES } from './courses-grammar.js?v=37cbf7b3';
import { DETAILED_GRAMMAR_COURSES } from './courses-grammar-detailed.js?v=37cbf7b3';
import { BEGINNER_GRAMMAR_COURSES } from './courses-grammar-beginner.js?v=37cbf7b3';
// 초급 1단계 — 설계는 docs/curriculum-beginner.md
import { BEGINNER_STAGE1_COURSES } from './courses-beginner-stage1.js?v=37cbf7b3';
