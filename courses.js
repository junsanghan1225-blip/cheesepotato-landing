...
import { GRAMMAR_COURSES } from './courses-grammar.js?v=05f58aa1';
import { DETAILED_GRAMMAR_COURSES } from './courses-grammar-detailed.js?v=05f58aa1';
import { BEGINNER_GRAMMAR_COURSES } from './courses-grammar-beginner.js?v=05f58aa1';
// 초급 1단계 — 설계는 docs/curriculum-beginner.md
import { BEGINNER_STAGE1_COURSES } from './courses-beginner-stage1.js?v=05f58aa1';
