...
import { GRAMMAR_COURSES } from './courses-grammar.js?v=a81a5be3';
import { DETAILED_GRAMMAR_COURSES } from './courses-grammar-detailed.js?v=a81a5be3';
import { BEGINNER_GRAMMAR_COURSES } from './courses-grammar-beginner.js?v=a81a5be3';
// 초급 1단계 — 설계는 docs/curriculum-beginner.md
import { BEGINNER_STAGE1_COURSES } from './courses-beginner-stage1.js?v=a81a5be3';
