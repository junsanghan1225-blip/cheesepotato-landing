...
import { GRAMMAR_COURSES } from './courses-grammar.js?v=f28d9cbe';
import { DETAILED_GRAMMAR_COURSES } from './courses-grammar-detailed.js?v=f28d9cbe';
import { BEGINNER_GRAMMAR_COURSES } from './courses-grammar-beginner.js?v=f28d9cbe';
// 초급 1단계 — 설계는 docs/curriculum-beginner.md
import { BEGINNER_STAGE1_COURSES } from './courses-beginner-stage1.js?v=f28d9cbe';
