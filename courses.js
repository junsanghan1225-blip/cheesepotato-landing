...
import { GRAMMAR_COURSES } from './courses-grammar.js?v=72b87a3a';
import { DETAILED_GRAMMAR_COURSES } from './courses-grammar-detailed.js?v=72b87a3a';
import { BEGINNER_GRAMMAR_COURSES } from './courses-grammar-beginner.js?v=72b87a3a';
// 초급 1단계 — 설계는 docs/curriculum-beginner.md
import { BEGINNER_STAGE1_COURSES } from './courses-beginner-stage1.js?v=72b87a3a';
// 초급 2단계 — 시간을 얹기
import { BEGINNER_STAGE2_COURSES } from './courses-beginner-stage2.js?v=72b87a3a';
// 초급 3단계 — 이어 말하기
import { BEGINNER_STAGE3_COURSES } from './courses-beginner-stage3.js?v=72b87a3a';
// 초급 4단계 — 상대에게
import { BEGINNER_STAGE4_COURSES } from './courses-beginner-stage4.js?v=72b87a3a';
// 초급 5단계 — 마음을 담기
import { BEGINNER_STAGE5_COURSES } from './courses-beginner-stage5.js?v=72b87a3a';
// 초급 6단계 — 다듬기
import { BEGINNER_STAGE6_COURSES } from './courses-beginner-stage6.js?v=72b87a3a';
// 초급 보충 — 110개 문법 목록에 없지만 실전에 꼭 필요한 것 (§8)
import { BEGINNER_EXTRA_COURSES } from './courses-beginner-extra.js?v=72b87a3a';
