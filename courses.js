...
import { GRAMMAR_COURSES } from './courses-grammar.js?v=51c8147c';
import { DETAILED_GRAMMAR_COURSES } from './courses-grammar-detailed.js?v=51c8147c';
import { BEGINNER_GRAMMAR_COURSES } from './courses-grammar-beginner.js?v=51c8147c';
// 초급 1단계 — 설계는 docs/curriculum-beginner.md
import { BEGINNER_STAGE1_COURSES } from './courses-beginner-stage1.js?v=51c8147c';
