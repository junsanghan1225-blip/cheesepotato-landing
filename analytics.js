/* 치즈감자 — 방문 기록 (Microsoft Clarity)
   ...
   **쿠키를 쓴다.** 예전 머리말은 안 쓴다고 적어 두었는데 사실이 아니었다 —
   Clarity 는 기본으로 첫자리 쿠키 둘(_clck 1년, _clsk 1일)을 심어 같은
   사람의 여러 방문을 잇는다. 개인정보처리방침에 그 둘을 이름과 기간까지
   적어 두었으니 여기 적힌 말과 어긋나면 안 된다.
